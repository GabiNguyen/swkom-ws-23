...
/**
 * DTO for {@link at.fhtw.swkom.paperless.persistence.model.DocumentsCorrespondent}
 */
public class DocumentsCorrespondentDto implements Serializable {
    ...
    public DocumentsCorrespondentDto(Integer id, String name, String match, Integer matchingAlgorithm, Boolean isInsensitive, AuthUserDto owner) {
        this.id = id;
        this.name = name;
        this.match = match;
